...
import { productSchema, type IProduct } from "~/miniProject/interface";
...

{
  ...
  const { context, callApiProduct } = useProduct();
  ...
  const onSubmit = async (data: IProduct) => {
    await callApiProduct({ ...data, id: selectedProduct?.id }, type);
    onCloseDrawer();
    reset();
  };
