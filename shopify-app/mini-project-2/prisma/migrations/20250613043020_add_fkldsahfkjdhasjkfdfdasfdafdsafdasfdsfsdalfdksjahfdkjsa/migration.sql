...
INSERT INTO "new_Customers" ("created_at", "customerId", "email", "firstName", "id", "lastName", "rankingId") SELECT "created_at", "customerId", "email", "firstName", "id", "lastName", "rankingId" FROM "Customers";
